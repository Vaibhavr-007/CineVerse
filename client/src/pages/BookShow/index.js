    ...
    show && (
      <div>
        ...
        {selectedSeats.length > 0 && (
          <div className="mt-2 flex justify-center mt-2 gap-2 items-center flex-col">
            <div className="flex justify-center">
              <div className="flex uppercase card p-2 gap-3">
                <h1 className="text-sm">
                  <b>Selected Seats </b> : {selectedSeats.length}
                </h1>
                <h1 className="text-sm">
            ...
            <StripeCheckout
              ...
              currency="inr"
              billingAddress
              stripeKey="pk_test_51NNzMtSCv5wLOkE9I2A5pphcLNbEVCYc0PghQYNLSiwHzBEk9OIB7kwS7goe5kGn4UHTcnAUPARabiefeX77bcvC00spGmL8WM"
